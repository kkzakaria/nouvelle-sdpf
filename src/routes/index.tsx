...
function Home() {
  ...
  const goSearch = () => navigate({ to: '/catalogue', search: { q: q || undefined, cat: undefined } })
    ...
    <div className="pb-nav">
      <section className="hero">
        ...
        <div className="hero-cta">
          ...
          <Link to={'/devis' as any} className="btn btn-ghost">Devis</Link>
        </div>
      </section>
      ...
      <div className="pad">
        ...
        <div className="cat-grid">
          {categories.map((c) => <CategoryCard key={c.slug} category={c} count={counts[c.slug] ?? 0} />)}
        </div>
